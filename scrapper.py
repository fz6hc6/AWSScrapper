...
target_url="https://www.amazon.es/dp/B0CQP9S8Q2"
...
try:
    o["priceold"]=soup.find("span",{"class":"a-price"}).find("span").text
except:
    o["priceold"]=None

# Extract the previous price
try:
    o["priceold"] = soup.select_one('.basisPrice .a-text-price .a-offscreen').text.strip()
except:
    o["priceold"]=None
